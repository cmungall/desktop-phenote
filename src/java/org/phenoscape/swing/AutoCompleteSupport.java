...
public final class AutoCompleteSupport<E> {
    ...
    private AutoCompleteSupport(JComboBox comboBox, EventList<E> items, TextFilterator<E> filterator, Format format) {
        ...
        final RangeList<E> rangeList = new RangeList<E>(this.filteredItems);
        rangeList.setHeadRange(0, 100);
        this.comboBoxModel = new AutoCompleteComboBoxModel(rangeList);
    ...
    private class AutoCompleteComboBoxModel extends EventComboBoxModel<E> {
        ...
        public void setSelectedItem(Object selected) {
          ...
          if ((selected != null) && (this.validItemClass != null) && (!(this.validItemClass.isInstance(selected)))) return;
            doNotFilter = true;
...
//                doNotChangeDocument = false;
    ...
    public void setValidItemClass(Class<?> clazz) {
      this.comboBoxModel.setValidItemClass(clazz);
    }
}
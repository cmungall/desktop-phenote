...
//System.out.println("postgres_table : "+postgres_table+" query : "+joinkey+" boxI : "+boxI+" colI : "+colI+" end.");      
...
//    System.out.println("SELECT * FROM "+postgres_table+" WHERE app_wbpaper ~ '"+pubID+"' ORDER BY app_timestamp"); 
    ...
    try { while (rs.next()) { sb.append(rs.getString(3)).append(" -- "); } }		// append the new term value
      ...
      System.out.println("We got an exception while getting a queryPostgresPapRemHist "+postgres_table+" result:this shouldn't happen: we've done something really bad."); se.printStackTrace(); System.exit(1); } 
...
//      postgres_table = "app_phenotype"; postgres_value = "No postgres value assigned";
//      nbp = queryPostgresCharacter(s, postgres_table, postgres_value, joinkey);
//
...
System.out.println("returning charList");
return charList; 
} 	// if there is a match

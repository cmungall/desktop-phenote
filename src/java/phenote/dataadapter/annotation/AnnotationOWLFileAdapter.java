...
public class AnnotationOWLFileAdapter extends AbstractFileAdapter {

  private File previousFile;
  private File file;
  private static String[] extensions = {"owl", "annotation-owl"};
  private static String desc = "Annotation-OWL [.obo, .annotation-owl]";
  private static Logger LOG = Logger.getLogger(AnnotationOWLFileAdapter.class);

...
public class GOAssociationFileAdapter extends AbstractFileAdapter {

  private File previousFile;
  private File file;
  private static String[] extensions = {"obo", "annotation-obo"};
  private static String desc = "Annotation-OBO [.obo, .annotation-obo]";
  private static Logger LOG = Logger.getLogger(GOAssociationFileAdapter.class);

  public GOAssociationFileAdapter() {
...
//this doesn't seem to do anything
  ...
  public CharacterListI load(File f) {
    ...
    GOStyleAnnotationFileAdapter fa = new GOStyleAnnotationFileAdapter();
    ...
    try { // throws data adapter exception
      ...
      OBOSession os = (OBOSession)  fa.doOperation(OBOAdapter.READ_ONTOLOGY,cfg,null);

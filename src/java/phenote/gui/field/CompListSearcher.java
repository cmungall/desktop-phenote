...
public class CompListSearcher {
  ...
  private Vector<CompletionTerm> getSearchTerms(String input,
    ...
    if (ontologyTermList == null)
      return searchTermList.getVector();//searchTerms;
  ...
  private class SearchTermList {
    private Vector<CompletionTerm> searchTerms = new Vector<CompletionTerm>();
    ...
    private Vector<CompletionTerm> containTerms = new Vector<CompletionTerm>();
    ...
    private void addTerm(OBOClass oboClass,boolean first) {
      ...
      if (first) searchTerms.add(0,t);
      else searchTerms.add(t);

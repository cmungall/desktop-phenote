...
public class TransferableCharacterCollection implements Transferable {
  ...
  private final Collection<CharacterI> characters;

  public TransferableCharacterCollection(Collection<CharacterI> theCharacters) {
